...
public class KMeansOutputLoader extends LoadFunc {
    ...
    protected RecordReader<IntWritable, WeightedVectorWritable> reader = null;
    protected BagFactory bagFactory = BagFactory.getInstance();
    protected TupleFactory tupleFactory = TupleFactory.getInstance();

    private static final Logger LOG = LoggerFactory.getLogger(KMeansOutputLoader.class);
    ...
    public void prepareToRead(RecordReader reader, PigSplit split) {
        this.reader = (RecordReader<IntWritable, WeightedVectorWritable>) reader;
    }
