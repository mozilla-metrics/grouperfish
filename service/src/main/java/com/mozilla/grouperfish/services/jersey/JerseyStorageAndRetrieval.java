...
public class JerseyStorageAndRetrieval implements StorageAndRetrieval {
     ...
     */
    public JerseyStorageAndRetrieval(final Injector parentInjector,
        ...
        final int port = Integer.parseInt(System.getProperty(
                "grouperfish.rest.port",
                String.valueOf(Grouperfish.DEFAULT_PORT)));
